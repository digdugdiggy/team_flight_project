		...
		if (commandMode == 0){
			...
			console.log("     Java client connected...");
				...
				commandReceiver.on('data', function (moveCommand) {
					//console.log("     Received from Java: " + moveCommand);   
					if (readyReceive == true){
					...
					//Makes one move command then waits until readyReceive reset by timed loop
					readyReceive = false;
					}
				});
			...
			server.listen(socket, function () {
				console.log("     JS Listening On Port: " + socket);
			});
		}
